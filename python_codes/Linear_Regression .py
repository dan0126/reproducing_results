...
def valores(b): #Returns observed values
...
def solve():
    ...
    #where the first value is the linear coefficient and the second is the slope.
...
def grafic():
    ...
    ax.plot(x,y_lin , color='k', label = ('AAD = ' + str(np.round(aad(),decimals = 2))+ '% '))
    ax.scatter(x, y, edgecolor='k', facecolor='grey', alpha=0.7, label='Sample data')
    ax.set_ylabel('Boiling point, Tb [K]', fontsize=14)
